...
// +kubebuilder:rbac:groups=config.ratify.dev,resources=executorpodstatuses,verbs=get;list;watch
// +kubebuilder:rbac:groups=config.ratify.dev,resources=executors,verbs=get;list;watch
