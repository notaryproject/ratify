...
| `healthPort`                              | Port exposed for the liveness and readiness health endpoints.                                                                                                                                                                               | `9090`                                          |
...
| `provider.probes.enabled`                 | Enable Kubernetes liveness and readiness probes for the Ratify provider pod.                                                                                                                           | `true`                                          |
| `provider.probes.liveness.initialDelaySeconds` | Delay before starting liveness checks.                                                                                                                                                            | `5`                                             |
| `provider.probes.liveness.periodSeconds`  | Interval between liveness checks.                                                                                                                                                                      | `10`                                            |
| `provider.probes.readiness.initialDelaySeconds` | Delay before starting readiness checks.                                                                                                                                                          | `5`                                             |
| `provider.probes.readiness.periodSeconds` | Interval between readiness checks.                                                                                                                                                                     | `10`                                            |
